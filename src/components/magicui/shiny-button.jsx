...
const ShinyButton = ({
  ...
  return (
    ...
    <motion.button
      ...
      <span
        className="relative block h-full w-full text-sm uppercase tracking-wide text-[rgb(0,0,0)] dark:font-light dark:text-[rgba(255,253,253,0.9)]"
        style={{
          maskImage:
      ...
      <span
        style={{
          mask: "linear-gradient(rgb(0,0,0), rgb(0,0,0)) content-box,linear-gradient(rgb(1,1,1), rgb(0,0,0))",
